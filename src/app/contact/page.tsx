          ...
          <div className="contact-info">
            ...
            <ul className="space-y-4 text-base text-text-light">
             ...
             <div className="social-icons flex gap-4 mt-8">
                 <a href="#" target="_blank" rel="noopener noreferrer" className="social-icon inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-200 text-brand-gold transition-all duration-fast ease-in-out hover:bg-brand-gold hover:text-white hover:scale-110" aria-label="Instagram">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                </a>
                 <a href="#" target="_blank" rel="noopener noreferrer" className="social-icon inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-200 text-brand-gold transition-all duration-fast ease-in-out hover:bg-brand-gold hover:text-white hover:scale-110" aria-label="Facebook">
