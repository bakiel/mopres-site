 ...
 * This uses the fixed implementation that properly handles Promises
 */
export async function sendOrderEmail(options) {
  ...
  try {
    ...
    // Call the standalone edge function - use the original function name until fixed one is deployed
